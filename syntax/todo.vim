...
syntax  match  TodoPriorityA  '^([aA])\s.\+$'             contains=TodoDate,TodoProject,TodoContext,OverDueDate,TodoNote
...
syntax  match  TodoNote       '\(\s\+\)\@<=note:[A-Za-z0-9_~\/]\+' contains=None
...
highlight  default  link  TodoNote       Operator
